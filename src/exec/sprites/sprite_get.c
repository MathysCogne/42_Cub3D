...
void	set_sprite(t_sprite *sprite, t_map *map,
					double angle_diff, t_textures *textures)
{
	double	sprite_dx;
	double	sprite_dy;
...
void	try_set_sprite(t_pos *pos, t_sprite *sprite,
						t_textures *textures, t_map *map)
{
	...
	sprite_dy = sprite->pos.y + 0.5 - map->player.pos.y;
	sprite_dx = sprite->pos.x + 0.5 - map->player.pos.x;
	angle_diff = trigo_get_angle(sprite_dx, sprite_dy)
		/ (M_PI / 180.0)
